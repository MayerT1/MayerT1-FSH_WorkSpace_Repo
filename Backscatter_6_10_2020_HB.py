...
path = r'C:\Users\hbaldwin\Desktop\FSH'

########### x data  ###SAR
im = Image.open(path + r'\Gamma_pw_clip_snap.tif')
xdata = np.array(im)  
...
########## y data  ###Lidar
im_lidar = Image.open(path + r'\hmean_degree_setnull.tif')

#im_lidar.show()
#Image.new("RGB",(300, 300), (50, 255, 80)).show()
#y_out = np.array(im_lidar) 
ydata = np.array(im_lidar) 
